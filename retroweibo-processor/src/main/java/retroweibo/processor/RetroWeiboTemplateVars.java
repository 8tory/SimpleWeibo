...
/**
 * The variables to substitute into the retroweibo.vm template.
 *
 * @author emcmanus@google.com (Éamonn McManus)
 */
@SuppressWarnings("unused")  // the fields in this class are only read via reflection
class RetroWeiboTemplateVars extends TemplateVars {

  /** The properties defined by the parent class's abstract methods. */
  List<RetroWeiboProcessor.Property> props;
  ...
  String pkg;
  /**
   * The name of the class with the {@code @RetroWeibo} annotation, including containing
   * classes but not including the package name.
   */
  String origClass;
  /** The simple name of the class with the {@code @RetroWeibo} annotation. */
  String simpleClassName;
  /** The simple name of the generated subclass. */
  String subclass;

  /**
   * The formal generic signature of the class with the {@code @RetroWeibo} annotation and its
   ...
   * builder type. If class {@code Address} contains {@code @RetroWeibo.Builder} class Builder
   * then this will typically be {@code "Address.Builder"}.
   */
  String builderTypeName = "";

  /**
   * The formal generic signature of the {@code RetroWeibo.Builder} class. This is empty, or contains
  ...
  /**
   * The simple names of validation methods (marked {@code @RetroWeibo.Validate}) in the RetroWeibo
   * class. (Currently, this set is either empty or a singleton.)
   */
  Set<String> validators = Collections.emptySet();

  private static final SimpleNode TEMPLATE = parsedTemplateForResource("retroweibo.vm");
