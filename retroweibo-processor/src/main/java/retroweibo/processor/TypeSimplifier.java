...
final class TypeSimplifier {
   ...
   * the package containing the RetroWeibo class, provided that the result refers to the type
  ...
  // If we have @RetroWeibo abstract class Foo<T extends SomeClass> then this method will
  ...
  // If we have @RetroWeibo abstract class Foo<T extends Something> then the subclass will be
  // final class RetroWeibo_Foo<T extends Something> extends Foo<T>.
