...
/**
 * Tests to ensure annotations are kept on RetroWeibo generated classes
 *
 * @author jmcampanini
 */
public class PropertyAnnotationsTest extends TestCase {
  ...
  private static final String PROPERTY_ANNOTATION_TEST =
      "retroweibo.processor.PropertyAnnotationsTest";
  private static final String TEST_ANNOTATION =
      "@retroweibo.processor.PropertyAnnotationsTest.TestAnnotation";
  ...
  private JavaFileObject expectedCode(List<String> annotations) {
    ...
    String[] lines = list.toArray(new String[list.size()]);
    return JavaFileObjects.forSourceLines("foo.bar.RetroWeibo_Baz", lines);
  }
