...
import retroweibo.processor.RetroWeiboBuilderProcessor;
import retroweibo.processor.RetroWeiboProcessor;
...
public class CompilationTest extends TestCase {
  public void testCompilation() {
    ...
    // Most RetroWeibo code-generation tests are functional, meaning that we check that the generated
    ...
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        "foo.bar.RetroWeibo_Baz",
        "package foo.bar;",
        "",
        "final class RetroWeibo_Baz extends Baz {",
        "  private final int buh;",
        "",
        "  RetroWeibo_Baz(int buh) {",
        "    this.buh = buh;",
        "  }",
        "",
  ...
  public void testImports() {
    ...
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new RetroWeibo_Baz(ints, arrays);",
        "  }",
        "}");
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        "foo.bar.RetroWeibo_Baz",
        ...
        "",
        "  RetroWeibo_Baz(int[] ints, Arrays arrays) {",
        "    if (ints == null) {",
        ...
        "    if (o instanceof Baz) {",
        "      Baz that = (Baz) o;",
        "      return (Arrays.equals(this.ints, (that instanceof RetroWeibo_Baz) "
                      + "? ((RetroWeibo_Baz) that).ints : that.ints()))",
  ...
  public void testNoObjectArrays() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new RetroWeibo_Baz(strings);",
        "  }",
        "}");
    assertAbout(javaSource())
        .that(javaFileObject)
  ...
  public void testAnnotationOnInterface() throws Exception {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new RetroWeiboProcessor())
        .failsToCompile()
        .withErrorContaining("RetroWeibo only applies to classes")
  ...
  public void testExtendRetroWeibo() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Outer",
        "package foo.bar;",
        "",
        ...
        "      return new RetroWeibo_Outer_Parent(randomProperty);",
        "    }",
        "",
        ...
        "      return new RetroWeibo_Outer_Child(randomProperty);",
        "    }",
        "",
        "    abstract int randomProperty();",
        "  }",
  ...
  public void testNonExistentSuperclass() throws Exception {
    // The main purpose of this test is to check that RetroWeiboProcessor doesn't crash the
  ...
  public void testCannotImplementAnnotation() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new RetroWeibo_RetentionImpl(policy);",
        "  }",
        "",
  ...
  public void testCorrectBuilder() throws Exception {
    ...
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        ...
        "          && (Arrays.equals(this.aByteArray, "
                    + "(that instanceof RetroWeibo_Baz) "
                        + "? ((RetroWeibo_Baz) that).aByteArray : that.aByteArray()))",
        "          && (Arrays.equals(this.aNullableIntArray, "
                    + "(that instanceof RetroWeibo_Baz) "
                        + "? ((RetroWeibo_Baz) that).aNullableIntArray : that.aNullableIntArray()))",
        ...
        "      }",
        "      Baz<T> result = new RetroWeibo_Baz<T>(",
  ...
  public void testRetroWeiboBuilderOnTopLevelClass() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Builder",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderNotInsideRetroWeibo() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
        ...
        "    return new RetroWeibo_Baz.Builder();",
        "  }",
        "",
        "  @RetroWeibo.Builder",
        "  public interface Builder {",
  ...
  public void testRetroWeiboBuilderOnEnum() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderDuplicate() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderMissingSetterUsingSetPrefix() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderWrongTypeSetter() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderWrongTypeSetterWithGetPrefix() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderExtraSetter() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderSetPrefixAndNoSetPrefix() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderMissingBuildMethod() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderDuplicateBuildMethods() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderWrongTypeBuildMethod() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderTypeParametersDontMatch1() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderTypeParametersDontMatch2() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderTypeParametersDontMatch3() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderToBuilderWrongTypeParameters() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderToBuilderDuplicate() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboValidateNotInRetroWeibo() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboValidateWithoutBuilder() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testRetroWeiboBuilderValidateMethodStatic() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new RetroWeiboProcessor(), new RetroWeiboBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@RetroWeibo.Validate cannot apply to a static method")
        .in(javaFileObject).onLine(10);
  }

  public void testRetroWeiboBuilderValidateMethodNotVoid() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new RetroWeiboProcessor(), new RetroWeiboBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@RetroWeibo.Validate method must be void")
        .in(javaFileObject).onLine(10);
  }

  public void testRetroWeiboBuilderValidateMethodWithParameters() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new RetroWeiboProcessor(), new RetroWeiboBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@RetroWeibo.Validate method must not have parameters")
        .in(javaFileObject).onLine(10);
  }

  public void testRetroWeiboBuilderValidateMethodDuplicate() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new RetroWeiboProcessor(), new RetroWeiboBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("There can only be one @RetroWeibo.Validate method")
        .in(javaFileObject).onLine(13);
  }
  ...
  public void testGetFooIsFoo() throws Exception {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new RetroWeiboProcessor())
        .failsToCompile()
        .withErrorContaining("More than one @RetroWeibo property called foo")
        .in(javaFileObject).onLine(8);
  }

  private static class PoisonedRetroWeiboProcessor extends RetroWeiboProcessor {
    private final IllegalArgumentException filerException;

    PoisonedRetroWeiboProcessor(IllegalArgumentException filerException) {
  ...
  public void testExceptionBecomesError() throws Exception {
    ...
    // RetroWeiboProcessor or javac.
    // We inject an exception by subclassing RetroWeiboProcessor in order to poison its processingEnv
    ...
    assertAbout(javaSource())
        .that(javaFileObject)
        .processedWith(new PoisonedRetroWeiboProcessor(exception))
        .failsToCompile()
