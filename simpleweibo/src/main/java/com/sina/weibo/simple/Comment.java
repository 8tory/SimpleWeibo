...
public abstract class Comment implements android.os.Parcelable {
    ...
    public abstract String inReplyToCommentId();
    @Nullable
    ...
    public abstract Comment retweetedComment();
    @Nullable
    ...
    public abstract static class Builder {
        ...
        public abstract Builder inReplyToCommentId(String x);
        ...
        public abstract Builder retweetedComment(Comment x);
