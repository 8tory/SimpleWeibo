...
public @interface RetroWeibo {
   ...
   * no-argument method in an RetroWeibo class. It will be called by the {@code build()} method of
   * the {@link Builder @RetroWeibo.Builder} implementation, immediately after constructing the new
